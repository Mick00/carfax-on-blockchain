...
const Report = () => {
  ...
  const sendOnChain = async (
    ...
    console.log(carId.toString(), reportHash, odometer.toString());
    reportContract
      .create(carId, reportHash, odometer)
      .then((r) => r.wait(1))
      .then((c) => {
        console.log(c);
        SetAlertError(false);
